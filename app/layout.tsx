...
export const metadata: Metadata = {
  metadataBase: new URL('https://green.craudiovizai.com'),
  ...
  title: 'Javari Sustainability',
  description: 'AI tools for ESG reporting, carbon tracking, and sustainability planning.',
  twitter: { card: 'summary_large_image', images: ['/og-image.png'] },
  openGraph: { images: [{ url: '/og-image.png', width: 1200, height: 630 }], title: 'Javari Sustainability', description: 'AI tools for ESG reporting, carbon tracking, and sustainability planning.', type: 'website' },
}
      ...
      <body style={{ margin: 0, padding: 0, fontFamily: 'system-ui, sans-serif' }}>
        <div style={{ background: 'rgba(0,0,0,0.88)', backdropFilter: 'blur(8px)', padding: '6px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 200 }}>
          <a href="https://craudiovizai.com" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', color: '#fff', fontSize: 13, fontWeight: 600 }}>
            <span>🌱</span>
            <span style={{ color: '#10b981' }}>Javari Sustainability</span>
